    ...
    return (
      <div className='coin-info-sub-wrapper'>
        <div className='coin-info-column coin-info-column-title'>
          <span className='coin-info-label'>{t('coin.balance')}</span>
        ...
        <div className='coin-info-column coin-info-column-right coin-info-column-balance'>
          <span className='coin-info-label'>{t('coin.balance.free')}</span>
          <HightlightChange className='coin-info-value'>
            {parseFloat(baseAssetBalance.free).toFixed(basePrecision)}
          </HightlightChange>
        </div>
        <div className='coin-info-column coin-info-column-right coin-info-column-balance'>
          <span className='coin-info-label'>{t('coin.balance.locked')}</span>
          <HightlightChange className='coin-info-value'>
