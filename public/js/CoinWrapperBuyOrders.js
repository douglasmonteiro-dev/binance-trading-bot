        ...
        <div
          ...
          <div className='coin-info-column coin-info-column-title'>
            <div className='coin-info-label d-flex flex-row'>
              <span>{t('coin.buyOrders.openOrder', { index: index + 1 })}</span>{' '}
              <SymbolCancelIcon
                symbol={symbol}
                order={openOrder}
            ...
            {openOrder.updatedAt && moment(openOrder.updatedAt).isValid() ? (
              <HightlightChange
                ...
                {t('coin.buyOrders.placedAt', {
                  time: moment(openOrder.updatedAt).format('HH:mm:ss')
                })}
              </HightlightChange>
            ) : (
              ''
          ...
          <div className='coin-info-column coin-info-column-order'>
            <span className='coin-info-label'>{t('coin.buyOrders.type')}</span>
            <HightlightChange className='coin-info-value'>
              {openOrder.type}
            </HightlightChange>
          </div>
          <div className='coin-info-column coin-info-column-order'>
            <span className='coin-info-label'>{t('coin.buyOrders.qty')}</span>
            <HightlightChange className='coin-info-value'>
          ...
          {openOrder.limitPrice ? (
            <div className='coin-info-column coin-info-column-order'>
              <span className='coin-info-label'>
                {t('coin.buyOrders.currentLimitPrice')}
              </span>
              <HightlightChange className='coin-info-value'>
          ...
          {openOrder.differenceToCancel ? (
            <div className='coin-info-column coin-info-column-order'>
              <span className='coin-info-label'>
                {t('coin.buyOrders.differenceToCancel')}
              </span>
              <HightlightChange className='coin-info-value'>
          ...
          {openOrder.differenceToExecute ? (
            <div className='coin-info-column coin-info-column-order'>
              <span className='coin-info-label'>
                {t('coin.buyOrders.differenceToExecute')}
              </span>
              <HightlightChange className='coin-info-value'>
    ...
    return (
      <div className='coin-info-sub-wrapper'>
        <div className='coin-info-column coin-info-column-title border-bottom-0 mb-0 pb-0'>
          <div className='coin-info-label'>{t('coin.buyOrders.title')}</div>
        </div>
        {renderOpenOrders}
      </div>
    );
